...
The simulation software (Monte Carlo and Molecular Dynamics codes) developed and used in this project is available **[here](https://github.com/MatevzTurk/MS_Software)**.
